...
const PROXY_CONFIG = {
  '/api/contentservices/api/contentstream/resourceRepository/contextRoot/static/items/bb-prospect-ang/assets/jumioMock.html': {
    target: 'http://localhost:4201/assets/jumioMock.html',
    secure: false,
    pathRewrite: {
        '^/api/contentservices/api/contentstream/resourceRepository/contextRoot/static/items/bb-prospect-ang/assets/jumioMock.html': '',
    },
