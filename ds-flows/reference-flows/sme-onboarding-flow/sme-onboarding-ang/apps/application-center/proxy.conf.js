...
const PROXY_CONFIG = {
  '/api/contentservices/api/contentstream/resourceRepository/contextRoot/static/items/bb-application-center-ang/assets/jumioMock.html': {
    target: 'http://localhost:4202/assets/jumioMock.html',
    secure: false,
    pathRewrite: {
        '^/api/contentservices/api/contentstream/resourceRepository/contextRoot/static/items/bb-application-center-ang/assets/jumioMock.html': '',
    },
