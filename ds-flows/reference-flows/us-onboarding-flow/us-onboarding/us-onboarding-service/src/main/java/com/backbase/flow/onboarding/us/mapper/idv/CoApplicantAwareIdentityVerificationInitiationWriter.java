...
@Component
public class CoApplicantAwareIdentityVerificationInitiationWriter implements JourneyWriter<Map> {
    ...
    public Case write(Map journeyData, String subject, String context, Case aCase) {
        ...
        applicant.put(IdentityVerificationContext.INITIATION, journeyData);
